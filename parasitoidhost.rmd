...
This Rmarkdown of Nicholson-Bailey (Nicholson and Bailey 1935) and negative-binomial (May 1978) parasitoid-host model was written by Ottar N. Bjornstad and is released with a CC-BY-NC license for anyone to improve and re-share (acknowledging origin). Please email me a copy if you make an update (onb1 at psu dot edu).

The app requires the shiny package to be installed to run. 
```{r}
require(shiny)
```
...
Nicholson AJ, Bailey VA (1935) The balance of animal populations. Proceedings of the Zoological Society of London 3: 551-598.