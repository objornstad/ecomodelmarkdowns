...
This Rmarkdown of the Spatially-extewnded parasitoid-host Model was written by Ottar N. Bjørnstad and is released with a CC-BY-NC lisence for anyone to improve and re-share (acknowledging origin). Please email me a copy of update (onb1 at psu dot edu). The app was originally developed as part of the "epimdr-packag"Epidemics: Models and Data UseR book  (https://cran.r-project.org/package=epimdr; Bjørnstad 2019).
