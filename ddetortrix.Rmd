...
Version 0.2-1 September 27, 2019 
...
We define the stage-specific life-history functions for development ($h_i(t)$), birth ($b(t)$) and mortality rates ($g_i(t)$) as
\begin{eqnarray}
...
| Parameter    Value               Description
  ...
  : Parameter estimates based on laboratory data.

[\[table1\]]{#table1 label="table 1"}
